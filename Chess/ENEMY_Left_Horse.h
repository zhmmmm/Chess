...
class ENEMY_Left_Horse :public Piece, public Piece_Logic, public _____Elephant__TO__Soldier__Logic__
{
	int mENEMY_Left_Horse_Bmpid = 0;
	int mENEMY_Left_Horse_X;
	int mENEMY_Left_Horse_Y;
...
public:
	...
	void PieceLogicUpdata(int Which, int State, int Mouse_X, int Mouse_Y)  //棋子逻辑更新
	{
		if (Piece::Reutrn_mWe() == 1)//1表示我可以走棋了
		{
			if (Which == 1 && State == 1)
			{
				if (Mouse_X >= mENEMY_Left_Horse_X - 30 && Mouse_X <= mENEMY_Left_Horse_X + 30
					&& Mouse_Y >= mENEMY_Left_Horse_Y - 30 && Mouse_Y <= mENEMY_Left_Horse_Y + 30)
				{
					if (Piece_Logic::mWE_CommandState || Piece_Logic::mWE_CommandState == 0)
					{
						Piece_Logic::mWE_CommandState = 80;//左边的马被锁定
					}
				}
				if (Piece_Logic::mWE_CommandState == 80)//左边的马被锁定
				{
					...
					Bool_0_LeftForward = _____Elephant__TO__Soldier__Logic__::_0__Horse_MoveForwardTarget(mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, Mouse_X, Mouse_Y);
					Bool_1_RightForward = _____Elephant__TO__Soldier__Logic__::_1__Horse_MoveBackTarget(mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, Mouse_X, Mouse_Y);
					Bool_2_LeftBack = _____Elephant__TO__Soldier__Logic__::_2__Horse_MoveLeftTarget(mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, Mouse_X, Mouse_Y);
					Bool_3_RightBack = _____Elephant__TO__Soldier__Logic__::_3__Horse_MoveRightTarget(mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, Mouse_X, Mouse_Y);
					Bool_4_LeftForward = _____Elephant__TO__Soldier__Logic__::_4__Horse_MoveForwardTarget(mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, Mouse_X, Mouse_Y);
					Bool_5_RightForward = _____Elephant__TO__Soldier__Logic__::_5__Horse_MoveBackTarget(mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, Mouse_X, Mouse_Y);
					Bool_6_LeftBack = _____Elephant__TO__Soldier__Logic__::_6__Horse_MoveLeftTarget(mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, Mouse_X, Mouse_Y);
					Bool_7_RightBack = _____Elephant__TO__Soldier__Logic__::_7__Horse_MoveRightTarget(mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, Mouse_X, Mouse_Y);
	...
	{
		__Bool_0_LeftForward(Bool_0_LeftForward, mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, 80);
		__Bool_1_RightForward(Bool_1_RightForward, mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, 80);
		__Bool_2_LeftBack(Bool_2_LeftBack, mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, 80);
		__Bool_3_RightBack(Bool_3_RightBack, mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, 80);
		//后面
		__Bool_4_LeftForward(Bool_4_LeftForward, mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, 80);
		__Bool_5_RightForward(Bool_5_RightForward, mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, 80);
		__Bool_6_LeftBack(Bool_6_LeftBack, mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, 80);
		__Bool_7_RightBack(Bool_7_RightBack, mENEMY_Left_Horse_X, mENEMY_Left_Horse_Y, 80);
		return 0;
	}
