...
public:
	...
	{
		__BoolLeftForward(BoolLeftForward, mENEMY_Right_Elephant_X, mENEMY_Right_Elephant_Y, 30);
		__BoolRightForward(BoolRightForward, mENEMY_Right_Elephant_X, mENEMY_Right_Elephant_Y, 30);
		__BoolLeftBack(BoolLeftBack, mENEMY_Right_Elephant_X, mENEMY_Right_Elephant_Y, 30);
		__BoolRightBack(BoolRightBack, mENEMY_Right_Elephant_X, mENEMY_Right_Elephant_Y, 30);
		return 0;
	}
