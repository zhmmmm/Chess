...
public:
	...
	{
		__BoolForward(BoolForward, mWE_Right_Chariot_Y, 1);
		__BoolBack(BoolBack, mWE_Right_Chariot_Y, 1);
		__BoolLeft(BoolLeft, mWE_Right_Chariot_X, 1);
		__BoolRight(BoolRight, mWE_Right_Chariot_X, 1);
		return 0;
	}
