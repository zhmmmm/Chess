...
public:
	...
	{
		__Bool_0_LeftForward(Bool_0_LeftForward, mWE_Right_Horse_X, mWE_Right_Horse_Y, 2);
		__Bool_1_RightForward(Bool_1_RightForward, mWE_Right_Horse_X, mWE_Right_Horse_Y, 2);
		__Bool_2_LeftBack(Bool_2_LeftBack, mWE_Right_Horse_X, mWE_Right_Horse_Y, 2);
		__Bool_3_RightBack(Bool_3_RightBack, mWE_Right_Horse_X, mWE_Right_Horse_Y, 2);
		//后面
		__Bool_4_LeftForward(Bool_4_LeftForward, mWE_Right_Horse_X, mWE_Right_Horse_Y, 2);
		__Bool_5_RightForward(Bool_5_RightForward, mWE_Right_Horse_X, mWE_Right_Horse_Y, 2);
		__Bool_6_LeftBack(Bool_6_LeftBack, mWE_Right_Horse_X, mWE_Right_Horse_Y, 2);
		__Bool_7_RightBack(Bool_7_RightBack, mWE_Right_Horse_X, mWE_Right_Horse_Y, 2);
		return 0;
	}
