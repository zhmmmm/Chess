...
class ENEMY_2_Soldier :public Piece, public Piece_Logic, public _____Elephant__TO__Soldier__Logic__
{
	...
	int mENEMY_2_Soldier_X;
	int mENEMY_2_Soldier_Y;
...
public:
	...
	{
		__BoolForward(BoolForward, mENEMY_2_Soldier_Y, 150, 0);
		__BoolLeft(BoolLeft, mENEMY_2_Soldier_X, 150, 0);
		__BoolRight(BoolRight, mENEMY_2_Soldier_X, 150, 0);
		return 0;
	}
